...
!0);h*=2}1<=m&&(1<m&&(n._d=n._d.slice(0,1-m)),w(n));-1===c&&n.invm(!0);return q(this,n,f)};var u={PI:"3.1415926535897932384626433832795028841972",E:"2.7182818284590452353602874713526624977573",MbnP:g};d.PI=function(){return new d(u.PI)};d.E=function(){return new d(u.E)};d.MbnP=function(){return new d(u.MbnP)};var B={abs:1,inva:2,ceil:1,floor:1,invm:2,sqrt:1,round:1,sgn:1,"int":1};p=["bop","pc"];var A=["num","name","uop","po"],E={"|":[1,!0,"max"],"&":[2,!0,"min"],"+":[3,!0,"add"],"-":[3,!0,"sub"],
"*":[4,!0,"mul"],"#":[4,!0,"mod"],"/":[4,!0,"div"],"^":[5,!1,"pow"]},C={num:{rx:/^([0-9\.,]+)\s*/,next:p.concat("pr"),end:!0},name:{rx:/^([A-za-z_]\w*)\s*/},fn:{next:["po"],end:!1},vr:{next:p,end:!0},bop:{rx:/^([-+\*\/#^&|])\s*/,next:A,end:!1},uop:{rx:/^([-+])\s*/,next:A,end:!1},po:{rx:/^(\()\s*/,next:A,end:!1},pc:{rx:/^(\))\s*/,next:p,end:!0},pr:{rx:/^(%)\s*/,next:p,end:!0}};d.eval=function(a,f){a=a.replace(/^\s+/,"");var b={};if(void 0!==f)for(var c in f)f.hasOwnProperty(c)&&(b[c]=new d(f[c]));
var e=A,k=e.length;c=!1;for(var g=[],h=[],m=!1,n=null,l,p=[4,!0,"inva"];0<a.length;){l=null;for(c=0;c<k&&null===l;c++)n=e[c],l=a.match(C[n].rx);if(null===l)if("bop"===e[0])c="*",n="bop";else throw new MbnErr(".eval","unexpected",a);else c=l[1],a=a.slice(l[0].length);"uop"!==n&&m&&(h.push(p),m=!1);switch(n){case "num":g.push(new d(c));break;case "name":if(B.hasOwnProperty(c)&&1===B[c])n="fn",h.push([4,!0,c]);else if(b.hasOwnProperty(c))n="vr",g.push(new d(b[c]));else if(u.hasOwnProperty(c))n="vr",
g.push(new d(u[c]));else throw new MbnErr(".eval","undefined",c);break;case "bop":for(c=E[c];-1!==(e=h.length-1);)if(k=h[e],"("!==k&&k[0]>c[0]-(c[1]?1:0))g.push(h.pop()[2]);else break;h.push(c);break;case "uop":"-"===c&&(m=!m);break;case "po":h.push(c);break;case "pc":for(;-1!==(e=h.length-1);)if(k=h[e],"("!==k)g.push(h.pop()[2]);else{h.pop();break}if(-1===e)throw new MbnErr(".eval","unexpected",")");e=h.length-1;-1!==e&&4===h[e][2]&&g.push(h.pop()[2]);break;case "pr":g[g.length-1].div(100,!0)}e=
C[n].next;k=e.length;c=C[n].end}for(;0!==h.length;)if(b=h.pop(),"("!==b)g.push(b[2]);else throw new MbnErr(".eval","unexpected","(");if(!c)throw new MbnErr(".eval","unexpected","END");h=[];b=g.length;for(c=0;c<b;c++)m=g[c],m instanceof d?h.push(m):B.hasOwnProperty(m)?("int"===m&&(m="intp"),h[h.length-1][m](!0)):(n=h.pop(),h[h.length-1][m](n,!0));return h[0]};for(var D in u)u.hasOwnProperty(D)&&(u[D]=new d(u[D]));return d},Mbn=MbnCr();