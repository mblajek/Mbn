...
<div style="border:2px solid green; max-width:512px; margin-left:auto; margin-right:auto; padding:2px;">
    ...
    <div style="float:right; border: 1px solid black;">
        <button style="background-color:lightgray; cursor:pointer; border:none; padding:1px; font-size:1em;"
                onclick="pchange(0, true);" id="mbnst"></button>
        <button style="background-color:lightgray; cursor:pointer; border:none; padding:1px; font-size:1em;"
                onclick="pchange(-1);">&lt;
        </button>
        <button style="background-color:white; border:none; padding:1px; font-size:1em; width:30px;" id="mbnp"
                disabled></button>
        <button style="background-color:lightgray; cursor:pointer; border:none; padding:1px; font-size:1em;"
                onclick="pchange(1);">&gt;
        </button>
