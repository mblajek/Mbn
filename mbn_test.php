...
function testMbn () {
   ...
   $tests[] = ['(new Mbn("1"))->split([0,1,1])', '0.00,0.50,0.50'];
   $tests[] = ['(new Mbn("1"))->split([1,1,0])', '0.50,0.50,0.00'];
   $tests[] = ['(new Mbn("100"))->split([99.99,0.01])', '99.99,0.01'];
   $tests[] = ['(new Mbn("100"))->split([0.01,99.99])', '0.01,99.99'];
